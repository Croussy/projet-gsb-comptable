...
// permet de modifier le libellé d'une ligne HF en y ajoutant "REFUSE"
...
/* retourne le mois reporté d'un mois 
 * on test quel est le mois fourni en paramètre 
 * si il est différent du mois de décembre alors 
		on passe au suivant
   sinon 
		on passe a l'année suivante puis on repasse au mois de janvier
*/
...
//retourne la requete qui retourne toutes les fiches validées
